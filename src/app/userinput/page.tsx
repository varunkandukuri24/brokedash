        ...
        <div className="bg-orange-200 border-black border-4 rounded-lg shadow-2xl w-full max-w-md mx-auto flex flex-col">
          ...
          <div className="flex flex-col p-4">
            <div className="flex items-center justify-between mb-4 pb-4 border-b-2 border-black">
              <span className="text-black font-semibold text-sm sm:text-base">1 x food you bought instead of groceries</span>
              <div className="flex items-center">
                ...
                <Input
                  ...
                  className="w-24 sm:w-28 text-right bg-white border-black [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  placeholder="0.00"
                  disabled={!isEditable}
                />
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="bg-white rounded-full p-1 flex border-2 border-black">
                {incomeOptions.map((option) => (
                  <button
                    key={option.value}
                    className={`flex-1 py-2 px-1 rounded-full text-xs sm:text-sm transition-colors duration-300 ${
                      income === option.value 
